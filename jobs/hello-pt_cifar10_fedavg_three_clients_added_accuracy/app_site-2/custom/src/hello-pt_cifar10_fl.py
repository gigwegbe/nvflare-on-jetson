...
# def main():
#     batch_size, epochs, lr = 32, 3, 0.01
#     model = SimpleNetwork()
#     device = torch.device("cuda:0" if torch.cuda.is_available() else "cpu")
...
#     train_loader = DataLoader(CIFAR10(
#         root=os.path.join(DATASET_PATH, client_name), train=True,
#         download=True, transform=transforms),
#         batch_size=batch_size, shuffle=True)

#     val_loader = DataLoader(CIFAR10(
#         root=os.path.join(DATASET_PATH, client_name), train=False,
#         download=True, transform=transforms),
...
#         # Training loop with batch loss logging
#         model.train()
#         for epoch in range(epochs):
#             running_loss = 0.0
...
#                 if i % 300 == 0:  # log every 300 batches
...
#         # Validation loop for accuracy logging
#         model.eval()
#         correct = total = 0
#         with torch.no_grad():
...
#         summary_writer.add_scalar("accuracy_per_round", accuracy, current_round)
...
#     # Use unique log directory per client
